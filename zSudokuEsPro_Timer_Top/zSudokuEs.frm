...
Private Sub Timer1_Timer()
    ...
    zCount = 0
    For i = 0 To 80
        'Text1(i).ForeColor <> &HC0C0FF
        If Text1(i).ForeColor = vbRed And Text1(i).Text <> Empty And zCheck(i) Then zCount = zCount + 1
        If zCount >= znum Then Label3 = useTime & "秒已完成": Timer1.Enabled = False: Exit For
    Next
    useTime = useTime + 1
End Sub
